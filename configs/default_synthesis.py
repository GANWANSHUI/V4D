...
coarse_train = dict(
    ...
    N_rand=4196,                  # batch size (number of random rays per optimization step), 6192  8192, 16384, 32768

    lrate_density=0.2,           # lr of density voxel grid
    lrate_density_feat=0.2,      # lr of density_feat voxel grid
    lrate_k0=0.2,                # lr of color/feature voxel grid
    lrate_k0_1=0.2,  # lr of color/feature voxel grid
...
fine_train.update(dict(
    ...
    pg_scale=[20000, 50000, 80000, 100000],
